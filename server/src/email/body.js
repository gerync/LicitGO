import EmailStyle from "./style.js";
...
export default function generateEmailBody(type, lang, info) {
    ...
    switch (type) {
        case 'verification':
            if (lang.toUpperCase() === 'HU') {
                html = `<div class="email-body">
                    <p class="email-header">Kedves Felhasználó!</p>
                        <div class="email-content">
                        <p>Az alábbi kód segítségével hitelesítheti email címét:</p>
                        <h2 class="email-code">${info.code}</h2>
                            <p>Ha nem Ön hozta létre ezt a kódot, kérjük, hagyja figyelmen kívül ezt az emailt.</p>
                        </div>
                            <p class="email-footer">Köszönjük, hogy a LicitGO-t használja!</p>
                    </div>`;
            } else {
                html = `<div class="email-body">
                    <p class="email-header">Dear User,</p>
                        <div class="email-content">
                        <p>Please verify your email address using the code below:</p>
                        <h2 class="email-code">${info.code}</h2>
                            <p>If you did not request this code, please ignore this email.</p>
                        </div>
                            <p class="email-footer">Thank you for using LicitGO!</p>
                    </div>`;
            }
            break;
        case 'reset-password':
            ...
            if (lang.toUpperCase() === 'HU') {
                html = `<div class="email-body">
                    <p class="email-header">Kedves Felhasználó!</p>
                        ...
                        <p>Végső ár: ${info.FinalPrice} HUF</p>
                        </div>
                            <p class="email-footer">Köszönjük, hogy a LicitGO-t használja!</p>
                    </div>`;
            } else {
                html = `<div class="email-body">
                    <p class="email-header">Dear User,</p>
                        ...
                        <p>Final Price: ${info.FinalPrice} HUF</p>
                        </div>
                            <p class="email-footer">Thank you for using LicitGO!</p>
                    </div>`;
            }
            ...
            if (lang.toUpperCase() === 'HU') {
                html = `<div class="email-body">
                    <p class="email-header">Kedves Felhasználó!</p>
                        ...
                        <p>Fizetendő ár: ${info.FinalPrice} HUF</p>
                        </div>
                            <p class="email-footer">Köszönjük, hogy a LicitGO-t használja!</p>
                    </div>`;
            } else {
                html = `<div class="email-body">
                    <p class="email-header">Dear User,</p>
                        ...
                        <h2><a href="${info.AuctionLink}">${info.CarManufacturer} ${info.CarModel}</a></h2>
                        <p>Amount to Pay: ${info.FinalPrice} HUF</p>
                        </div>
                            <p class="email-footer">Thank you for using LicitGO!</p>
                    </div>`;
            }
            ...
            if (lang.toUpperCase() === 'HU') {
                html = `<div class="email-body">
                    <p class="email-header">Kedves Felhasználó!</p>
                        ...
                        <h2><a href="${info.AuctionLink}">${info.CarManufacturer} ${info.CarModel}</a></h2>
                        <p>Új legmagasabb ajánlat: ${info.NewHighestBid} HUF</p>
                        </div>
                            <p class="email-footer">Köszönjük, hogy a LicitGO-t használja!</p>
                    </div>`;
            } else {
                html = `<div class="email-body">
                    <p class="email-header">Dear User,</p>
                        ...
                        <h2><a href="${info.AuctionLink}">${info.CarManufacturer} ${info.CarModel}</a></h2>
                        <p>New Highest Bid: ${info.NewHighestBid} HUF</p>
                        </div>
                            <p class="email-footer">${now}</p>
                    </div>`;
            }
            break;
        case 'startup-notification':
            if (lang.toUpperCase() === 'HU') {
                html = `<div class="email-body">
                    <p class="email-header">LicitGO Szerver Indítási Értesítés</p>
                        <div class="email-content">
                        <p>A LicitGO szerver sikeresen elindult.</p>
                        </div>
                            <p class="email-footer">${now}</p>
                    </div>`;
            } else {
                html = `<div class="email-body">
                    <p class="email-header">LicitGO Server Startup Notification</p>
                        <div class="email-content">
